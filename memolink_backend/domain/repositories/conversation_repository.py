...
class ConversationRepository:
    ...
    def add_message(self, conv_id: int, role: str, content: str, model: str | None = None, confidence: str | None = None, confidence_reason: str | None = None, source_note_ids: list | None = None) -> Message:
        msg = Message(conversation_id=conv_id, role=role, content=content, model=model, confidence=confidence, confidence_reason=confidence_reason, source_note_ids=source_note_ids)
        self.db.add(msg)
        self.db.commit()
        self.db.refresh(msg)
        return msg
