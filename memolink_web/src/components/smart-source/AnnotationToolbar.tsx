...
export function AnnotationToolbar(props: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 border-b border-[var(--ml-bg-hover)] bg-[var(--ml-bg-panel)] px-2 py-2 font-sans">
      ...
      <span className="ml-auto whitespace-nowrap text-[10px] text-gray-500">{props.saving ? "Saving…" : "Synced"}</span>
    </div>
  );
}
